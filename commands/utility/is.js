...
const alwaysIllegal = ['Buzz', 'Evie', 'Eimy', 'Lexi', 'Twisty', 'Vicki', 'Esther', 'Nicky', 'Manny', 'Frankie', 'Andy', 'Adrian', 'Erik', 'Deissy', 'Bam', 'Mel', 'Cody', 'Mike', 'Mikaroni', 'Abeka', 'Tom', 'Thomas', 'Renee', 'Mack', 'Pickelz', 'Nique', 'Rennie', 'Melissa', 'Bicki'];
